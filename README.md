...
### Expertise
- Languages/scripting experience: Python, Java, C/C++, HTML, SQL, Unix
- Tools experience: nmap, wireshark, burp suite, John The Ripper, Metasploitable Framework, etc

### Interests
- Interested in writing tools/scripts in security applications, vulnerability analysis, Penetration testing, system defense, AI security
